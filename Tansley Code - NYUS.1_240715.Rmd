...
#Set your working directory to folder where files are located

warmlength = 14 #Days of warming
warmperiod = rep(0:(warmlength-1), each=3) #days
warmstart = as.Date("2022-12-01")   # Use 3/1, 1/15, 12/1?
warmtemp=15  #Maximum temperature
warmamplitude=5 #How much lower than maximum T


wdat=read.csv("Weather_GenevaBordeaux.csv")
...
wdat$Dataset[month(wdat$date)>6]=paste((as.numeric(year(wdat$date[month(wdat$date)>6]))),(as.numeric(year(wdat$date[month(wdat$date)>6]))+1),sep="-" )
...
locdat=read.csv("Locations.csv")
locdat$Location=factor(locdat$Location)


wdat2=merge(wdat,locdat)

colnames(wdat2)=c("Location","Date","Tmin","Tmax","yday","Year","Month","Day","Dataset","artwarm",
...
wdat2warm$Dataset="2022-2023warm"


# # Uneven warming
# 
# wdat2warm$Tmin[wdat2warm$Month == warmmonth]=wdat2warm$Tmin[wdat2warm$Month == warmmonth]+warmlevel
# 
# wdat2warm$Tmax[wdat2warm$Month == warmmonth]=wdat2warm$Tmax[wdat2warm$Month == warmmonth]+warmlevel
# 
# #Even warming
# 
# wdat2warm$Tmin[wdat2warm$Month == warmmonth]=warmtemp-5
# wdat2warm$Tmax[wdat2warm$Month == warmmonth]=warmtemp
...
wdat2warm$Tmin[(which(wdat2warm$Date == warmstart)+warmperiod)]=warmtemp-warmamplitude
wdat2warm$Tmax[(which(wdat2warm$Date == warmstart)+warmperiod)]=warmtemp

wdat2warm$artwarm[(which(wdat2warm$Date == warmstart)+warmperiod)]=1



wdat2=rbind(wdat2,wdat2warm)
...
wdat3=wdat3[c(1,2,3,4,9,10,12,13,14,18)]
wdat3$Location2=factor(wdat3$Location2)
wdat3$Country=factor(wdat3$Country)

wdat4=aggregate(.~Date+Location+Location2+Country+Dataset,wdat3,mean)

wdat2c=wdat4
colnames(wdat2c)=c("Date", "Location","Location2", "Country","Dataset","MinC","MaxC","artwarm","JDay","Portions")




parms=data.frame(c("Concord","Concord_10","Concord_90","Cabernet_Sauvignon","Cabernet_Sauvignon_10","Cabernet_Sauvignon_90","Riesling","Riesling_10","Riesling_90"),
                 c(0,0,0,0,0,0,0,0,0),
                 c(12,10,12,8,6,10,12,10,14),
                 c(8,11,8,7,6,6,7,6,10),
                 c(66,66,66,66,66,66,66,66,66),
                 c(31,28,33,23,22,25,26,24,29),
                 c(6,6,6,6,6,6,6,6,6),
                 c(-2.1,-2.3,-2.2,-2.2,-1.7,-1.9,-1.9,-2,-1.9),
                 c(24,24,24,22,14,24,24,14,24),
                 c(1.9,1.9,1.9,1.8,1.7,1.7,2.2,2.2,2),
                 c(3.5,3.5,4,5,4,5,5,5,5),
                 c(3,3,2,6,7,4,3,3,2),
                 c(5,4,4,3,3,3,4,5,5))
...
{
tliml=parms$tliml[parms$Cultivar=="Concord_10"]
tlimh=parms$tlimh[parms$Cultivar=="Concord_10"]
tlimb=parms$tlimb[parms$Cultivar=="Concord_10"]
tlime=parms$tlime[parms$Cultivar=="Concord_10"]
m=parms$m[parms$Cultivar=="Concord_10"]
n=parms$n[parms$Cultivar=="Concord_10"]
b=parms$b[parms$Cultivar=="Concord_10"]
c=parms$c[parms$Cultivar=="Concord_10"]
kdeacc=parms$kdeacc[parms$Cultivar=="Concord_10"]
a=parms$a[parms$Cultivar=="Concord_10"]
Tmax=40
Topt=25
slp=parms$slp[parms$Cultivar=="Concord_10"]
int=parms$int[parms$Cultivar=="Concord_10"]
...
wdatvalb$Cultivar=as.factor("Concord_10")
preds=rbind(preds,wdatvalb)
...
{
tliml=parms$tliml[parms$Cultivar=="Concord_90"]
tlimh=parms$tlimh[parms$Cultivar=="Concord_90"]
tlimb=parms$tlimb[parms$Cultivar=="Concord_90"]
tlime=parms$tlime[parms$Cultivar=="Concord_90"]
m=parms$m[parms$Cultivar=="Concord_90"]
n=parms$n[parms$Cultivar=="Concord_90"]
b=parms$b[parms$Cultivar=="Concord_90"]
c=parms$c[parms$Cultivar=="Concord_90"]
kdeacc=parms$kdeacc[parms$Cultivar=="Concord_90"]
a=parms$a[parms$Cultivar=="Concord_90"]
Tmax=40
Topt=25
slp=parms$slp[parms$Cultivar=="Concord_90"]
int=parms$int[parms$Cultivar=="Concord_90"]
...
wdatvalb$Cultivar=as.factor("Concord_90")
preds=rbind(preds,wdatvalb)
...
{
tliml=parms$tliml[parms$Cultivar=="Cabernet_Sauvignon_10"]
tlimh=parms$tlimh[parms$Cultivar=="Cabernet_Sauvignon_10"]
tlimb=parms$tlimb[parms$Cultivar=="Cabernet_Sauvignon_10"]
tlime=parms$tlime[parms$Cultivar=="Cabernet_Sauvignon_10"]
m=parms$m[parms$Cultivar=="Cabernet_Sauvignon_10"]
n=parms$n[parms$Cultivar=="Cabernet_Sauvignon_10"]
b=parms$b[parms$Cultivar=="Cabernet_Sauvignon_10"]
c=parms$c[parms$Cultivar=="Cabernet_Sauvignon_10"]
kdeacc=parms$kdeacc[parms$Cultivar=="Cabernet_Sauvignon_10"]
a=parms$a[parms$Cultivar=="Cabernet_Sauvignon_10"]
Tmax=40
Topt=25
slp=parms$slp[parms$Cultivar=="Cabernet_Sauvignon_10"]
int=parms$int[parms$Cultivar=="Cabernet_Sauvignon_10"]
...
wdatvalb$Cultivar=as.factor("Cabernet_Sauvignon_10")
preds=rbind(preds,wdatvalb)
...
{
tliml=parms$tliml[parms$Cultivar=="Cabernet_Sauvignon_90"]
tlimh=parms$tlimh[parms$Cultivar=="Cabernet_Sauvignon_90"]
tlimb=parms$tlimb[parms$Cultivar=="Cabernet_Sauvignon_90"]
tlime=parms$tlime[parms$Cultivar=="Cabernet_Sauvignon_90"]
m=parms$m[parms$Cultivar=="Cabernet_Sauvignon_90"]
n=parms$n[parms$Cultivar=="Cabernet_Sauvignon_90"]
b=parms$b[parms$Cultivar=="Cabernet_Sauvignon_90"]
c=parms$c[parms$Cultivar=="Cabernet_Sauvignon_90"]
kdeacc=parms$kdeacc[parms$Cultivar=="Cabernet_Sauvignon_90"]
a=parms$a[parms$Cultivar=="Cabernet_Sauvignon_90"]
Tmax=40
Topt=25
slp=parms$slp[parms$Cultivar=="Cabernet_Sauvignon_90"]
int=parms$int[parms$Cultivar=="Cabernet_Sauvignon_90"]
...
wdatvalb$Cultivar=as.factor("Cabernet_Sauvignon_90")
preds=rbind(preds,wdatvalb)
...
{
tliml=parms$tliml[parms$Cultivar=="Riesling_10"]
tlimh=parms$tlimh[parms$Cultivar=="Riesling_10"]
tlimb=parms$tlimb[parms$Cultivar=="Riesling_10"]
...
guiana <- subset(stateprov, name %in% "Guyane française")
